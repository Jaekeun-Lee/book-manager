...
insert into user (`id`, `name`, `email`, `created_at`, `updated_at`) values (4, 'jack', 'james@gmail.com', now(), now());
insert into user (`id`, `name`, `email`, `created_at`, `updated_at`) values (5, 'jack', 'jack@naver.com', now(), now());
